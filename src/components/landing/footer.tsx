...
export function Footer() {
  return (
    <footer className="bg-[#0D1F17] text-[#F7F3ED]/40 py-12 px-4">
      <div className="container mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-none">
            <span className="font-display text-[#F7F3ED]/80 font-medium">Barrio Stefani</span>
            <span className="font-body text-[9px] tracking-[0.2em] uppercase text-[#F7F3ED]/30 mt-0.5">
